...
<%
	...
	System.out.println("Attribute: "+request.getAttribute("serverTime"));
%>
	...
	<div class="container">
		...
		<div class="tab-content">
			<div id="home" class="tab-pane fade in active">
				<h3>
					<a href="borrower">Click Here. try borrow a book!</a>
				</h3>
				<!--  
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img src="./resources/img/books.jpg" alt="book1" width="460" height="345">
					</div>

					<div class="item">
						<img src="./resources/img/books.jpg" alt="book2" width="460" height="345">
					</div>
					<div class="item">
						<img src="./resources/img/books.jpg" alt="book3" width="460" height="345">
					</div>
				</div>
